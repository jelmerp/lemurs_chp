...
## Settings:
# file.ID <- 'borsim_germarjol.mac3.FS7'; root <- 'mgri'
# file.ID <- 'ruftan.all.mac3.FS6'; root <- 'mgri'
file.ID <- 'ruftan.no_ruf.mac3.FS6'; root <- 'mgri'
# file.ID <- 'ruftan.no_mitlehmae.mac3.FS6'; root <- 'mgri'
# file.ID <- 'ruftan.no_mitleh.mac3.FS6'; root <- 'mgri'
...
## Metadata:
infile_lookup <- '/home/jelmer/Dropbox/sc_lemurs/proj/radseq/metadata/lookup_IDshort.txt'
...
## Process:
poporder <- unique(lookup$species.short)
